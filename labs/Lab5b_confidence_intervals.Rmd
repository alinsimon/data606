...
71.7 percent of adults think climate change affects their local community.
```{r samp-plot}
#set.seed(60)
ggplot(samp, aes(x = climate_change_affects)) +
  ...
  labs(
    x = "", y = "",
    title = "Do you think climate change is affecting your local community?",
    subtitle ="Sample Proportion (n=60)"
  ) +
  coord_flip() 
...
**Insert your answer here**
No, the sample proportion will be different because the sample proportion is selected randomly from the population although it will be somewhat similar. 
...
**Insert your answer here**
95% is the probability that the true proportion of the population will fall between the upper and lower values (bounds). 
...
**Insert your answer here**
Yes, the confidence interval captured the true population proportion of US adults who think climate change affects their local community (0.717). My neighbor's interval capture will also capture that value, his/her bounds will be slightly different because we setup a high percentage of probability in the confidence interval.
...
**Insert your answer here**
Even though each student should have gotten a slightly different confidence interval because the samples are randomly selected, they should capture the true population because of the high percentage of confidence interval used (95%).
...
The majority of the proportion for the confidence intervals includes the true population proportion, which is equal or closer to 95% confidence level.
...
**Insert your answer here**
I updated the confidence level to 85%, the other values remained the same. I expect a confidence interval at this level to be narrower than 95%. With a difference of 10% the true population proportion that falls into the bounds will also decrease.
...
**Insert your answer here**
There is a 68% confidence that the true population proportion of US adults who think climate change affects their local community is between intervals of 65.0% and 76.7%.
```{r samp-get_ci-68}
samp %>%
  specify(response = climate_change_affects, success = "Yes") %>%
  generate(reps = 1000, type = "bootstrap") %>%
...
**Insert your answer here**
Comparing 85% versus 95% confidence level,  the true population is lower and the confident level is narrower.
```{r samp-85}
...
**Insert your answer here**
In this case I used 90% confidence level, comparing this confident level with the previous example of 85%, this one is wider; the more confident you can be that your interval contains the true population, the wider the interval is.
For 90% confidence level, the bounds are 61.7% and 81.7% . 
```{r samp-90}
samp %>%
  specify(response = climate_change_affects, success = "Yes") %>%
  generate(reps = 1000, type = "bootstrap") %>%
...
**Insert your answer here**
As the sample size increases, the width of the intervals decreases, the reason to this is because larger sample sizes provide more precise estimate of the population parameters.
...
**Insert your answer here**
It narrows. Yes, increasing the number of bootstrap samples leads to more accurate estimates of the true population, and it decreases the standard error as well.
